...
- 本技能的本地记录目录固定为 `./r0/diagram-guard/`。
- 每次执行结束后，除文章内 `assets/diagrams/diagram_guard_report.json` 外，还必须沉淀一份本地结果摘要或演进记录到 `./r0/diagram-guard/`。
- `.gitignore` 统一规则为 `r0/`。
...
若发现新的坏图模式、修复盲区或高频重复操作，必须追加：
- `./r0/diagram-guard/bad-cases/...`
- `./r0/diagram-guard/research/...`
